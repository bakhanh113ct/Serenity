          ...
          child: Padding(
            ...
            child: Column(children: [
              Row(
                ...
                children: [
                SizedBox(width: 20,),
                Text("Create Order",style: TextStyle(color: CustomColor.second,fontSize: 28,fontWeight: FontWeight.w600),),
                Icon(Icons.chevron_right,color: CustomColor.second,size: 50,)
              ],),
              Row(children: [
                Expanded(
                  flex: 7,
